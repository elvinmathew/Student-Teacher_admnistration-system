...
<body>
    ...
    <div class="container mt-5">
        <h3 class="text-center">Teacher & Course Info</h3>
        <form action="updatefaculty" method="post" class="form-group">
            <label for="c_id">Course Id</label>
            <input type="number" name="c_id" placeholder="Enter Course Id" required>
            ...
            <input type="number" name="t_id" placeholder="Enter Teacher Id" required>
